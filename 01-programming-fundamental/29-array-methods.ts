...
{
  const array = [1, 2, 3, 4, 5, 6, 10, 90, 100, 60];
...
//Menggabungkan dua atau lebih array menjadi satu
{
  ...
  console.log(arraySecond.concat(arrayFirst, arrayThird));
}

/* -------------------------------- splice() -------------------------------- */
//Memotong sebuah array, dan bisa ngisi yang udah dipotong itu (CUT - Original array nya akan berubah)
//splice(start_index)
//splice(start_index, deleted_count)
//splice(start_index, deleted_count, item1, item 2,...., itemN)
{
  ...
  console.log(month.splice(2, 1, "November", "December"));
  console.log(month);
}

/* --------------------------------- slice() -------------------------------- */
//Memotong sebuah array, tapi gabisa ngisi yang udah dipotong itu (COPY - Original array nya ga akan berubah)
//slice()
//slice(start)
//slice(start, end)
{
...
/* -------------------------------- reverse() ------------------------------- */
//Memutar balik susunan (reverse) element di dalam suatu array
{
...
//2. Panjang array hasil manipulasi akan SELALU sama panjang nya dengan array original
{
  const array = [1, 2, 3, 4, 5];
  console.log(
    array.map(() => {
